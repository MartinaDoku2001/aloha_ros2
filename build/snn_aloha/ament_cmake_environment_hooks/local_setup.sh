...
: ${AMENT_CURRENT_PREFIX:="/workspace/aloha_mujoco_project/snn_aloha/install/snn_aloha"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/snn_aloha/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/snn_aloha/environment/path.sh"
